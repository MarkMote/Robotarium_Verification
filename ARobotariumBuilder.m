classdef ARobotariumBuilder < handle %% # MODIFIED for MCV
    ...
    properties (GetAccess = public, SetAccess = protected)
        ...
        number_of_agents
        asdf = 1 ; 
        save_data =  true;  %#REQ: Must be set to true 
        show_figure = false; %#REQ: Should be set to false    
    end
    ...
    methods                         
        ...
        function this = set_show_figure(this, show_figure)
           ...
           % this.show_figure = show_figure; % #MOD - disable users ability to turn on figure
        end
        ...
        function this = set_save_data(this, save_data)            
            ...
            %this.save_data = save_data;  % #MOD - disable users ability to turn off saving data
        end
    end   
end
